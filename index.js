...
class TagInput<T> extends React.PureComponent<Props<T>, State> {
  static propTypes = {
    ...
    inputProps: PropTypes.shape(TextInputPropTypes),
    maxHeight: PropTypes.number,
    onHeightChange: PropTypes.func,
    //scrollViewProps: PropTypes.shape(ScrollView.propTypes),
    scrollViewProps: PropTypes.any, // Temporary patch as propTypes have been removed from core and this one isn't in the deprecated library
